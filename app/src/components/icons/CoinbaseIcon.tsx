...
export const CoinbaseIcon: FC<BaseIconProps> = ({ height = 224.6, width = 229.9 }) => {
  return (
    <svg
      version="1.0"
      ...
      <path
        fill="#0052FF"
        d="M114.9,0L114.9,0c47.9,0,86.7,38.8,86.7,86.7l0,0c0,47.9-38.8,86.7-86.7,86.7l0,0
	c-47.9,0-86.7-38.8-86.7-86.7l0,0C28.2,38.8,67,0,114.9,0z"
      />
      <path
        fill="#FFFFFF"
        d="M115,117.2c-16.8,0-30.5-13.6-30.5-30.5S98.1,56.2,115,56.2c15.1,0,27.6,11,30,25.4h30.7
